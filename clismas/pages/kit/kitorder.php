			...
			<section class="content">
					...
					<div class="box box-success">
						<form class="form-horizontal">
							<div class="box-body">
								...
								<div class="form-group">
									<label for="address" class="col-md-2 control-label">Shipping Address</label>
									<div class="col-md-10">
										<div class="row">
											<div class="col-md-5">
								...
								<div class="form-group">
									<label for="phone" class="col-md-2 control-label">Tel.</label>
									<div class="col-md-10">
										<div class="row">
											<div class="col-md-5">
								...
								<div class="form-group">
									<label for="requester" class="col-md-2 control-label">Requestor</label>
									<div class="col-md-10">
										<div class="row">
											<div class="col-md-5">
								...
								<!-- Date -->
								<div class="form-group">
									<label for="datepicker" class="col-md-2 control-label">Desired date of receipt</label>
									<div class="col-md-10">
										<div class="row">
											<div class="col-md-5">
											...
											<div class="col-md-5">
												<p>*Kit Order 제출 후 CROCENT에서 Kit 제작 및 발송에 약 2주 정도 소요됩니다.</p>
											</div>
										</div>
									</div>
								</div>
				...
				<div class="box">
					<div class="box-header">
						<h3 class="box-title" id='yourOrder'>Order List</h3>
					</div>
					<!-- /.box-header -->
					<div class="box-body">
