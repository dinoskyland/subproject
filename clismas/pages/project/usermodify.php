					...
					<form class="form-horizontal">
						<div class="box-body">
							...
							<div class="form-group user-group">
								...
								<div class="col-md-5">
									<p class="margin" name='userid' id='userid'></p>
								</div>
							</div>
							...
							<div class="form-group pickup-group">
								...
								<div class="col-md-5">
									<p class="margin" name='staffid' id='staffid'></p>
								</div>
							</div>
							...
							<div class="form-group pickup-group">
								<label for="assignSite" class="col-md-2 control-label">Assigned Site</label>
								<div class="col-md-5">
									<p class="margin" name='site' id='site'></p>
								</div>
							</div>
							<!-- /.form group -->
