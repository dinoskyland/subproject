...
<!-- 												<input type="text" class="form-control" name="subjectInitial" id='subjectInitial'>
 -->											
												<select class='form-control selectpicker' name='subjectInitial' id='subjectInitial' title='Initial'>
												</select>
 											</div>
											<div class="col-md-2">
...
<!-- 												<input type="text" class="form-control" name="subjectNo" id='subjectNo'>
 -->											
												<select class='form-control selectpicker' name='subjectNo' id='subjectNo' title='No.'>
												</select>
 											</div>
											<div class="col-md-2">
