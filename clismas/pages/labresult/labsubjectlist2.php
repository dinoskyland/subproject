...
$subjectCode        = $_POST['subjectCodeResult'];
...
if ($subjectCode) {
    $sql = "SELECT DISTINCT bim05_subjects.sbj_cd, bim05_subjects.sbj_no, bim05_subjects.sbj_initial, sbj_random_no, sbj_birthdate, sbj_gender, t_receipt_cd, t_visit_cd, t_visit_name, t_sbj_cd
        ...
        where bim05_subjects.sbj_cd='$subjectCode' AND ptl_cd='$protocol' AND sbj_site='$site' AND $periodFrom <= SUBSTR(t_receipt_cd,1,6) AND SUBSTR(t_receipt_cd,1,6) <= $periodTo";
} else { //all subjects
    $sql = "SELECT DISTINCT bim05_subjects.sbj_cd, bim05_subjects.sbj_no, bim05_subjects.sbj_initial, sbj_random_no, sbj_birthdate, sbj_gender, t_receipt_cd, t_visit_cd, t_visit_name, t_sbj_cd 
        FROM bim05_subjects 
        INNER JOIN lrm02_test_result 
